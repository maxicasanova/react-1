const listaProductos = [
    {
        id:1,
        nombre:'tapiz mapache',
        descripcion:'realizado a partir de x materiales',
        precio:500,
        stock:10,
        initial:2,
